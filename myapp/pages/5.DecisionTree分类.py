...
st.set_page_config(page_title="🌳 Decision Tree 分类", layout="wide")
st.title("🌳 Decision Tree 分类模型分析")
...
if uploaded_file:
    ...
    if feature_cols:
        ...
        plot_tree(model, filled=True, feature_names=feature_cols, class_names=[str(i) for i in model.classes_], ax=ax)
        st.pyplot(fig)
